...
{
    public partial class MultinomialLogisticRegressionModelForm : Form
    {
        //Fields
        ...
        private MultinomialLogisticRegression multinomialLogisticRegression;
        ...
        //Constructor
        public MultinomialLogisticRegressionModelForm(DataTable inputData, string[] inputColumnNames, string outputColumnName)
        {
            InitializeComponent();
        ...
        private void learnButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (lowerBoundNewtonRaphsonRadioButton.Checked)
                {
                    ...
                    multinomialLogisticRegression = lowerBoundNewtonRaphson.Learn(inputColumns.Get(learningIndexes), outputGroupIndexes.Get(learningIndexes));
                }
                else if (conjugateGradientRadioButton.Checked)
                {
                    ...
                    multinomialLogisticRegression = multinomialLogisticLearning.Learn(inputColumns.Get(learningIndexes), outputGroupIndexes.Get(learningIndexes));
                }
        ...
        private void CreateSurface(string xAxisColumnName, string yAxisColumnName)
        {
            ...
            int[] result = multinomialLogisticRegression.Decide(map);
