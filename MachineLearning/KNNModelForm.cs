...
{
    public partial class KNNModelForm : Form
    {
        //Fields
        ...
        //Constructor
        public KNNModelForm(DataTable inputData, string[] inputColumnNames, string outputColumnName)
        {
            InitializeComponent();
            ...
            //Tab learning
            kNumericUpDown.Maximum = inputData.Rows.Count / 2;
        ...
        {
            int k = Convert.ToInt16(kNumericUpDown.Value);
            ...
            try
            {
                ...
                knn.Learn(inputColumns.Get(learningIndexes), outputGroupIndexes.Get(learningIndexes));
            }
        ...
        private void testButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                computedOutputsGroupIndexes = knn.Decide(inputColumns.Get(testingIndexes));
            }
            catch (Exception exception)
            {
                MessageBox.Show(this, exception.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
