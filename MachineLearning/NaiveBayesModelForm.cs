...
{
    public partial class NaiveBayesModelForm : Form
    {
        //Fields
        ...
        //Constructor
        public NaiveBayesModelForm(DataTable inputData, string[] inputColumnNames, string outputColumnName)
        {
            InitializeComponent();
        ...
        private void learnButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                naiveBayes = naiveBayesLearning.Learn(inputColumns.Get(learningIndexes), outputGroupIndexes.Get(learningIndexes));
            }
            ...
            probabilitiesDataGridView.DataSource = new ArrayDataView(naiveBayes.Distributions, inputColumnNames, outputGroupValues);
            foreach (DataGridViewColumn column in probabilitiesDataGridView.Columns)
                if (column.Index == 0)
                    column.HeaderText = outputColumnName;
                else
                    column.Width = 300;
        ...
        private void CreateSurface(string xAxisColumnName, string yAxisColumnName)
        {
            ...
            int[] result = naiveBayes.Decide(map);
        ...
        private void testButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                computedOutputsGroupIndexes = naiveBayes.Decide(inputColumns.Get(testingIndexes));
            }
            catch (Exception exception)
            {
                MessageBox.Show(this, exception.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void predictButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                outputGroupIndex = naiveBayes.Decide(inputValues);
            }
            catch (Exception exception)
            {
                MessageBox.Show(this, exception.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
