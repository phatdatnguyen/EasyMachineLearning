...
{
    public partial class KPCAModelForm : Form
    {
        //Fields
        ...
        //Constructor
        public KPCAModelForm(DataTable inputData, string[] inputColumnNames)
        {
            InitializeComponent();
        ...
        private void learnButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                kpca.Center = centerComboBox.Checked;
                kpca.Learn(inputColumns.Get(learningIndexes));
                projectionResult = kpca.Transform(inputColumns.Get(learningIndexes));
            }
            ...
            int numberOfPricipleComponents = Math.Min(Convert.ToInt32(numberOfComponentsNumericUpDown.Value), kpca.Components.Count);
            projectedDataDataGridView.Rows.Clear();
            projectedDataDataGridView.Columns.Clear();
            foreach (PrincipalComponent component in kpca.Components)
            {
            ...
            string[] cells = new string[kpca.Components.Count];
            ...
            proportionComponentView.DataSource = kpca.Components;
            cumulativeProportionComponentView.DataSource = kpca.Components;
            ...
            for (int columnIndex = 0; columnIndex < kpca.Components.Count; columnIndex++)
                cells[columnIndex] = "";
        ...
        private void principleComponentComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void projectButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                projectionResult = kpca.Transform(inputValues);
            }
            catch (Exception exception)
            {
                MessageBox.Show(this, exception.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void revertButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                reversionResult = kpca.Revert(inputValues.ToJagged().Transpose())[0];
            }
            catch (Exception exception)
            {
                MessageBox.Show(this, exception.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void inputSpaceZedGraphControl_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                result = kpca.Transform(new double[] { x, y });
            }
            catch
            {
                return;
        ...
        private void featureSpaceZedGraphControl_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                result = kpca.Revert((new double[] { x, y }).ToJagged().Transpose())[0];
            }
            catch
            {
                return;
